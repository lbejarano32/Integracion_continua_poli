                ...
                <div class="content-main">
                    ...
                    <div class="validation-system">
                        ...
                        <div class="validation-form">
                            ...
                            <h2 align="center">Paciente No Existe</h2>
                            <h3 align ="center">¿Desea Crearlo?</h3>
                            <br>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-1">
                            <form name="aceptar" action="../../../vistas/paciente/crear/registrarPaciente.php" method="POST"> 
                                <input type="submit" value="Aceptar" class="btn btn-primary"> 
                            </form> 
                                </div>
                            
                            <form name="cancelar" action="../../../vistas/paciente/editar/buscarPaciente.php" method="POST"> 
