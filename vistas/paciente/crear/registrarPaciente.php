                ...
                <div class="content-main">
                    ...
                    <div class="validation-system">
                        ...
                        <div class="validation-form">
                            ...
                            <form action = "../../../controladores/pacienteControlador.php" method = "post">

                                <h3 align = "center" style = "font-family:sans-serif">Crear Paciente</h3>
                                <br>
                                ...
                                <div class = "form-group">
                                    ...
                                    <div class="col-md-6 form-group form-last group-text ">
                                        ...
                                        <input class="form-control1" type="number" value="<?php echo $_GET['documento'];?>" placeholder="<?php echo $_GET['documento'];?>" id="numerodoc" name="documento">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 form-group1">
                                        ...
                                        <input type="text" placeholder="Eps" id="eps" name="eps" required="">
                                    </div>

                                    <div class="col-md-6 form-group2 group-mail">
                                        <label class="control-label">Rh</label>
                                        <select name="rh">
                                            <option value="" name="rh">Seleccione</option>
                                            <option value="AB+" name="rh">AB+</option>
                                            <option value="AB-" name="rh">AB-</option>
                                            <option value="A+" name="rh">A+</option>   
                                            <option value="A-" name="rh">A-</option>       
                                            <option value="B+" name="rh">B+</option>       
                                            <option value="B-" name="rh">B-</option>       
                                            <option value="O+" name="rh">O+</option>    
                                            <option value="O-" name="rh">O-</option>              
                                        </select>
                                    </div>
                                    ...
                                    <input type="submit" class="btn btn-primary" name="registroPaciente"/>
