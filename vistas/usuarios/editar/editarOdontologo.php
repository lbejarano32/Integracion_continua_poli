                ...
                <div class="content-main">
                    ...
                    <div class="validation-system">
                        ...
                        <div class="validation-form">
                            ...
                            if ($_SESSION['id'] != NULL) {
                                $pDao = new odontologoDao();
                                $paciente = $pDao->buscarOdontologoid($_SESSION['id']);

                                if (!empty($paciente)) {
                                    foreach ($paciente as $pa) {
                                        ?>  

                                        <form  id="formulario" action="../../../controladores/odontologoControlador.php" method="GET">
                                            <input value="<?php echo $pa['id']; ?>" name="idDoctor" hidden="true">

                                            <h3 align="center" style="font-family:sans-serif">Actualizar Datos</h3>
                                            <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="submit" class="btn btn-primary" name="modificarOdontologo"/>
