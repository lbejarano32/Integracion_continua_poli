                ...
                <div class="validation-system">
                    ...
                    <div class="validation-form">
                        ...
                        <div class="col-md-12">
                            ...
                            <form  id="formulario" method="post" action="../../../controladores/pacienteControlador.php">
                                <br>
                                <div class="md-col-6">
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="submit" class="btn btn-primary" id="consultar" name='consultarAgendar' value="Consultar"/>
