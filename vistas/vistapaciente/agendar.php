                ...
                <div class="content-main">
                    ...
                    <div class="validation-system">
                        ...
                        <div class="validation-form">
                            ...
                            <h3 align="center" style="font-family:sans-serif; color: #3FB5C4"><strong>Agendamiento Cita</strong></h3>
                            <br>
                                ...
                                <div class="validation-form">
                                    ...
                                    <div class="vali-form">
                                        ...
                                        if ($_SESSION['documento'] != NULL) {
                                            ...
                                            $paciente = $pDao->buscarPaciente($_SESSION['documento']);
                                                ...
                                                foreach ($paciente as $pa) {
                                                    ...
                                                    foreach ($tipodocumento as $td) {
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6 form-group2 group-mail">
                                                                ...
                                                                <select name="especialidad">
                                                                    ...
                                                                    <option name="especialidad" value="iseño de Sonrrisa">Diseño de Sonrisa</option>
                                                            ...
                                                            <div class="col-md-6 form-group2 group-mail">
                                                                ...
                                                                <input  class="form-control1" type="text" id="fecha" name="fecha" required="true" placeholder="yyyy-mm-dd"/>
                                                            </div>
                                                            <div class="col-md-6 form-group2 group-mail">
                                                        ...
                                                        <br>
                                                            ...
                                                            <input type="submit" class="btn btn-primary" name="agendarCitap" value="Aceptar"/>
